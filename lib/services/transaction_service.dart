...
class TransactionService {
  ...
  Future<List<TransactionRecord>> getAllTransactions({
    ...
    try {
      ...
      if (transactionType != null)
        endpoint += '&transaction_type=${transactionType.name}';
  ...
  Future<TransactionRecord?> createTransaction(
    ...
    try {
      final transactionData = {
        ...
        'quantity_unit': transaction.quantityUnit,
      };
  ...
  // Get customer transactions by phone
  Future<List<TransactionRecord>> getCustomerTransactions(String phone) async {
    try {
      final response = await ApiService.get('/customers/$phone/transactions');
      final List<dynamic> transactionsData = response as List<dynamic>;
      ...
      print('Failed to fetch customer transactions: $e');
      return [];
    }
  }
}
